...
const pastEvents = [
  {
    ...
    description: "Insights and experiences from past entrepreneurs.",
    icon: Event1,
  ...
  },
  {
    ...
    description: "Exploring the journey of successful startups.",
    icon: Event1,
...
const Events = () => {
  return (
    <div className="flex flex-col bg-[#003c43] px-4 py-6 md:px-12 md:py-16" id="events">
      ...
      <div className="p-4 mb-8 rounded-lg bg-emerald-50">
        <EventCard
